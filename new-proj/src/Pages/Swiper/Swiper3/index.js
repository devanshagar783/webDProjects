...
import "./index.scss";
import { FreeMode, Grid, Mousewheel, Pagination, Scrollbar } from "swiper";
...
const Swiper3 = () => {
    ...
    return (
      <div className='swiper3'>
        <Swiper
        // direction='vertical' //for vertical direction
        // centeredSlides // for centering the slides
        
        // direction={"vertical"}
        // slidesPerView={"auto"}
        // scrollbar={true}
        //   freeMode //- for free navigatin of slides
        //   mousewheel
        // cssMode - for now slow changing
        ...
        >
          ...
          {/* //use with freemode, scrollbar, mousewheel */}
        {/* <SwiperSlide>
