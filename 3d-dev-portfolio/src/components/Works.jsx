...
const ProjectCard = ({
    ...
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
        ...
        >
            ...
            <div className="mt-5">
                <h3 className="text-white text-[24px] font-bold mt-5">
                    {name}
                </h3>
        ...
        <>
            ...
            <div className="w-full flex">
                ...
                >
                    ...
                    breifly described with links to code repositories and live
                    demo in it. It reflects my ability to solve complex
